...
public class MovePlate : MonoBehaviour
{
    ...
    void UpdateText(Chessman attacker, Chessman defender)
    {
        ...
        GameObject.FindGameObjectWithTag("Attacker").GetComponent<TMP_Text>().text = "Current health: " + (attacker.GetHealth() - defender.GetAttack()) + "\n" + "Damage taken: " + attacker.GetAttack() + "\n";
        GameObject.FindGameObjectWithTag("Defender").GetComponent<TMP_Text>().text =  "Current health: " + (defender.GetHealth() - attacker.GetAttack()) + "\n" + "Damage taken: " + defender.GetAttack();
    }
